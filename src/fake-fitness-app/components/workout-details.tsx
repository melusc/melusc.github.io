...
const toSpeed = (
  ...
  const parsedDistanceInMeters = +distance * 1000;
...
export const WorkoutDetails = ( properties: Readonly<{ duration: string; distance: string }> ): h.JSX.Element => {
          ...
          <div>
            <input
              ...
              onInput={event_ => {
                ...
                setTotalDuration( isValidDuration( value )
