  ...
  () => {
    ...
    describe(
      ...
      () => {
        ...
        it(
          'should find a pointing arrow of 3s.',
          () => {
            const layout: Array<Array<string | Array<string>>> = [
              [
                [ '2', '4', '5', '8' ],
                '1',
                '7',
            ...
            for ( const [ rowIndex, row ] of layout.entries() ) {
              for ( const [ colIndex, wantedCell ] of row.entries() ) {
                if ( Array.isArray( wantedCell ) ) {
                  emptySudoku._cells[ rowIndex * 9 + colIndex ].possible = new Set( wantedCell );
                }
                else {
            ...
            assert.deepStrictEqual(
              [ ...emptySudoku.getCell( 11 ).possible ],
              [ '6' ]
            );
          }
        );
        ...
        it(
          'should find a pointing arrow of 2s.',
          () => {
            const layout: Array<Array<string | Array<string>>> = [
              [
                '7',
