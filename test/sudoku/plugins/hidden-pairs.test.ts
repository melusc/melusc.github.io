...
describe('hidden-pairs.ts', () => {
	...
	describe('hiddenPairs()', () => {
		it('should find the hidden pairs ("3", "4", "9").', () => {
		...
		it('should find the only cell that can have "1".', () => {
			const possibles = [
				['2', '3', '5', '7', '9'],
				['3', '5', '6', '8'],
				['3', '4'],
		...
		it("should not modify any cells if there aren't any hidden pairs.", () => {
